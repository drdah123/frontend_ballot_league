...
function Leaderboard({
  ...
  return (
    <>
        ...
        <View style={styles.container}>
          {!more && (
            <View style={styles.container2}>
              ...
              <Text style={styles.textWhite}>الدوريات النشطة 1</Text>
              <Pressable style={styles.button} onPress={() => setMore(true)}>
                <Text style={styles.textButton}>اعرف المزيد</Text>
              </Pressable>
            </View>
          )}
          {more && (
            <View style={styles.container3}>
              ...
              <View style={styles.notsContainer}>
                <View style={styles.notContainer}>
                  ...
                  <View style={styles.sqaureNot}></View>
                </View>
                <View style={styles.notContainer}>
                  <Text style={styles.textNote}>يمكن بدء الدوري يدوياً.</Text>
                  <View style={styles.sqaureNot}></View>
                </View>
                <View style={styles.notContainer}>
                  <Text style={styles.textNote}>
                    يتم بدأ الدوري تلقائياً بعد ساعة. ويتم إلغاءه عند عدم تعيين
                    عدد كافي من المقاعد.
                  </Text>
                  <View style={styles.sqaureNot}></View>
                </View>
                <View style={styles.notContainer}>
                  <Text style={styles.textNote}>
                    يمكن للمنظم تحديد المقاعد أو ترك الحرية للمشتركين بختيار
                    مقاعدهم.
                  </Text>
                  <View style={styles.sqaureNot}></View>
                </View>
                <View style={styles.notContainer}>
                  <Text style={styles.textNote}>
                    يمكن للمنظم أو المشتركين في الدوري دعوة الآخرين عبر رابط
                    الدعوة.
                  </Text>
                  <View style={styles.sqaureNot}></View>
                </View>
      ...
      <CreateLeagueButton type="private" />
    </>
  );
}
